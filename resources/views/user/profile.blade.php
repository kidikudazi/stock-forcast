                                        ...
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                <li class="breadcrumb-item">
                                                    <a href="{{ url('user/home') }}"><i class="ti ti-home"></i></a>
                                                </li>
                                        ...
                                        <div class="row no-gutters">
                                                    ...
                                                    <div class="profile-img text-center rounded-circle">
                                                        <div class="pt-5">
                                                            <div class="bg-img m-auto">
                                                                <img src="{{ asset('assets/admin/img/user.png') }}" class="img-fluid" alt="users-avatar">
                                                            </div>
                                            ...
                                            <div class="col-xl-5 col-md-6 col-12 border-t border-right">
                                                <div class="page-account-form">
                                                    ...
                                                    <div class="p-4">
                                                        <form action="{{ url('user/update/profile') }}" id="profile" method="POST">
                                                            @csrf
                                                            <div class="form-row">
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <input type="email" class="form-control" name="email" id="email1" value="{{ $user->email }}" readonly>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="col-xl-4 col-md-6 border-t col-12">
                                                <div class="page-account-form">
                                                    ...
                                                    <div class="p-4">
                                                        <form action="{{ url('user/update/password') }}" id="password" method="POST">
                                                            @csrf
